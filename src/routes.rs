...
pub const COMMAND_ROUTE_TABLE: &[(&str, DispatchPlan)] = &[
    ...
    ("prekey_publish", SYMFONY_ONLY),
    ("prekey_bundle_request", SYMFONY_ONLY),
    ...
    ("sender_keys_commit", SYMFONY_ONLY),
    ("mls_welcome_request", SYMFONY_ONLY),
    ("sender_keys_welcome_request", SYMFONY_ONLY),
    ("mls_welcome_ack", SYMFONY_ONLY),
    ("sender_keys_welcome_ack", SYMFONY_ONLY),
    ("presence_state", SUBJECTS_ONLY),
    ("typing", SUBJECTS_ONLY),
    ("read", SYMFONY_ONLY),
    ("handshake_request", SYMFONY_ONLY),
    ...
    ("call_join", SYMFONY_ONLY),
    ("call_leave", SYMFONY_ONLY),
    ("call_mute", SYMFONY_ONLY),
    ("call_camera", SYMFONY_ONLY),
    ("call_invite", SYMFONY_ONLY),
    ("call_media_key", SYMFONY_ONLY),
    ("crypto_init", SYMFONY_ONLY),
    ("crypto_reply", SYMFONY_ONLY),
    ("chat", FASTPATH),
];
